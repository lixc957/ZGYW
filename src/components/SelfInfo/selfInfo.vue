<template>
  <div class="userInfo">
    ...
    <!-- 个人中心 -->
    <div class="info-top whiteBox">
      <img src="../../../static/img/charHead.png" alt />
    </div>
    <div class="info-main whiteBox">
      <el-tabs class=" noBack-tab" v-model="activeName" @tab-click="handleClick">
        <el-tab-pane label="信息概览" name="first">
          <div class="user-info">
            <div class="base-info">
              <p class="info-title">基本信息</p>
              <div class="block">
                <div class="row hasBacBox">
                  <span>用户名：</span>
        ...
        <el-tab-pane label="信息修改" name="second">
          <div class="info-edit">
            ...
            >
              ...
              <el-form-item>
                <el-button type="primary" @click="onSubmitInfo"
                  >确认修改</el-button
                >
...
import { selectCompany, checkPhone, checkEmail } from "../../utils";
export default {
  // 局部注册
  components: {
    MyBreadcrumb,
