...
<template>
  <div class="filt">
    ...
    <div class="show-page whiteBox" v-if="!filt_status">
      <div id="nav">
        <div class="tab hasBack-tab" v-if="variableArr.length">
          <el-tabs
            class="hasBack-tab"
      ...
      <div id="select" v-if="variableArr">
        ...
        <div class="right">
          ...
          <el-button
            ...
            :disabled="
              loading == true || variableArr.length == 0 || exportLoading
            "
      ...
      <div class="contentBox">
        <div class="tableHead">
          <table class="table" border="0" :style="{ width: conWidth + 'px' }">
            <tr>
        ...
        >
          <table class="table" border="0" ref="conBox">
            <tr
              v-for="item in arr"
              :key="item.id"
            ...
            >
              ...
              <td v-for="item1 in tableData" :key="item1.id">
                ...
                {{
                  item1.data[item.index] || item1.data[item.index] === 0
    ...
    <!-- 新增报表页面 -->
    <div class="add-filt whiteBox" v-if="filt_status">
      <p class="titleBox">添加报表配置</p>
      <div class="content">
        <div class="top">
          <div class="belong">
            <span>所属站点</span>
        ...
        <div class="bottom">
          ...
          <div class="select">
            <div class="single" v-for="(item, index) in watchArr" :key="index">
              ...
              >
                <i class="icon iconfont iconicon_shanchu-mian mini"></i
                >&nbsp;删除
              </el-button>
              <el-button
                size="mini"
    ...
    >
      ...
      <span slot="footer" class="dialog-footer">
        <el-button class="cancel" @click="deleteVisible = false"
          >取 消</el-button
        >
    ...
    >
      ...
      <span slot="footer" class="dialog-footer">
        <el-button class="cancel" @click="configVisible = false"
          >取 消</el-button
        >
...
import { getTimeArr, formatFilt, distinct } from "../../utils/index";
