<template>
  <div class="all whiteBox">
    ...
    <div class="layout" v-show="!ifHandle">
      ...
      <div class="foot">
        <el-button
          ...
          v-show="!ifEdit"
          :disabled="!this.$store.state.site.siteId"
          >编辑</el-button
        >
        <el-button
          type="primary"
    ...
    <div class="edit" v-show="ifHandle">
      <div class="back">
        <el-button type="primary" @click="trunBack" size="small"
          >返回</el-button
        >
        <el-button type="primary" @click="cancelSave" size="small"
          >取消</el-button
        >
      </div>
      <!------------------------------------ warnList -->
      ...
      <div class="singleMonitor" v-show="handleBoard == 'singleMonitor'">
        ...
        <!-- 背景图显示界面 -->
        <div
          class="singleMonitor-show"
          :style="{ background: this.singleMonitorBackground }"
        >
          <div
            class="left-top"
            :style="{
              'font-size': variateForm.param.nameSize + 'px',
              color: variateForm.param.titleColor
            }"
          >
            {{ variateForm.datas.data[0].name }}
          </div>
          <div
            class="bottom"
            :style="{
              'font-size': variateForm.param.valueSize + 'px',
              color: variateForm.param.valueColor
            }"
          >
            {{
              singleMonitorValue
                ? singleMonitorValue + variateForm.datas.data[0].unit
                : ''
            }}
          </div>
        </div>
        ...
        >
          <div>
            <el-form-item label="数据名称" class="input-block">
              <el-input
                v-model.trim="variateForm.datas.data[0].name"
              ></el-input>
            </el-form-item>
          </div>
          <div>
          ...
          <div style="margin-bottom: -16px">
            <el-form-item label="背景颜色-左上" class="input-block">
              <el-color-picker
                v-model="variateForm.param.ltColor"
                class="color"
              ></el-color-picker>
            </el-form-item>
            <el-form-item label="背景颜色-右下" class="input-block">
              <el-color-picker
                v-model="variateForm.param.rbColor"
                class="color"
              ></el-color-picker>
            </el-form-item>
            ...
            <el-form-item label="数据名称颜色" class="input-block">
              <el-color-picker
                v-model="variateForm.param.titleColor"
                class="color"
              ></el-color-picker>
            </el-form-item>
            <el-form-item label="数据值颜色" class="input-block">
              <el-color-picker
                v-model="variateForm.param.valueColor"
                class="color"
              ></el-color-picker>
            </el-form-item>
            <!-- </div> -->
        ...
        >
          <div class="item-single">
            ...
            <div v-for="(item, index) in lineChartForm.datas.data" :key="index">
              ...
              <div
                style="display: inline-block; position: relative; width: 360px"
              >
        ...
        >
          <div class="item-single">
            ...
            <div v-for="(item, index) in reportForm.datas.data" :key="index">
              ...
              <div
                style="display: inline-block; position: relative; width: 250px"
              >
                <el-form-item label="名称" class="input-block">
                  <el-input v-model.trim="item.name"></el-input>
                </el-form-item>
      ...
      <div class="totalEnergy" v-show="handleBoard == 'totalEnergy'">
        <el-form
          ref="form"
          :model="totalEnergyForm"
          label-width="80px"
          class="totalEnergyForm"
        >
          <div>
            <el-form-item label="标题" class="input-block">
      ...
      <div class="energyLine" v-show="handleBoard == 'energyLine'">
        <el-form
          ref="form"
          :model="energyLineForm"
          label-width="80px"
          class="energyLineForm"
        >
          <div>
            <el-form-item label="标题" class="input-block">
      ...
      <div class="powerConsumption" v-show="handleBoard == 'powerConsumption'">
        ...
        >
          <div class="item-single">
            <el-form-item label="标题" class="input-block">
              <el-input
                v-model.trim="powerConsumptionForm.param.title"
              ></el-input>
            </el-form-item>
            <el-form-item label="日期类型" class="input-block">
              <el-select
                v-model="powerConsumptionForm.param.timeType"
                placeholder
              >
                <el-option
            ...
            <el-form-item label="能耗类型" class="input-block">
              <el-select
                v-model="powerConsumptionForm.param.powerType"
                placeholder
              >
                <el-option
            ...
            <div
              v-for="(item, index) in powerConsumptionForm.datas.data"
              :key="index"
            >
              <div style="display: inline-block">
                <el-form-item label="选择网关" class="input-block">
      ...
      <div
        class="powerCurve"
        v-show="handleBoard == 'powerCurve'"
        style="height: 300px"
      >
        <div style="margin-top: 20px; border-top: 1px dashed #aaa"></div>
        <el-form
          ref="form"
          :model="powerCurveForm"
          label-width="80px"
          class="powerCurveForm"
        >
          <div class="item-single">
            <el-form-item label="标题" class="input-block">
            ...
            <div
              v-for="(item, index) in powerCurveForm.datas.data"
              :key="index"
            >
              <div style="display: inline-block">
                <el-form-item label="选择网关" class="input-block">
      ...
      <div class="powerProportion" v-show="handleBoard == 'powerProportion'">
        ...
        >
          <div class="item-single">
            <el-form-item label="标题" class="input-block">
              <el-input
                v-model.trim="powerProportionForm.param.title"
              ></el-input>
            </el-form-item>
            <el-form-item label="日期类型" class="input-block">
              <el-select
                v-model="powerProportionForm.param.timeType"
                placeholder
              >
                <el-option
                  v-for="(item, index) in timeTypeOption1"
            ...
            <el-form-item label="能耗类型" class="input-block">
              <el-select
                v-model="powerProportionForm.param.powerType"
                placeholder
              >
                <el-option
                  v-for="(item, index) in powerTypeOptions"
            ...
            <div
              v-for="(item, index) in powerProportionForm.datas.data"
              :key="index"
            >
              <div style="display: inline-block">
                <el-form-item label="选择网关" class="input-block">
    ...
    >
      <div class="block" v-for="(item, index) in arr" :key="index">
        <div class="d-title titleBox">
          <h3>
            <i
              :class="{
                icon: true,
                iconfont: true,
                iconzhexiantu: item.classify == '历史数据',
                iconwangguanzhuangtai: item.classify == '站点状态',
                icondata: item.classify == '关键数据',
                iconwarn: item.classify == '事件告警'
              }"
            ></i>
            &nbsp;{{ item.classify }}
          </h3>
...
export default {
  ...
  methods: {
    ...
    trunBack() {
      ...
      // 如果为----历史曲线或者是今日用能曲线------，则存储颜色至param,删除color属性
      if (
        this.backForm === 'lineChartForm' ||
        this.backForm === 'powerCurveForm'
      ) {
    ...
    moreVariableChange(index, e) {
      ...
      // 把修改后的变量的单位赋值给moreDataForm传入组件中
      this.moreDataForm.datas.data[index].unit = obj.unit
    },
    // 添加数据项
    addDataItem() {
    ...
    powerCurveGetVariable($event, index) {
      ...
      this.$http
        ...
        .then((res) => {
          if (res.data.code === 0) {
            this.powerCurveForm.datas.data[index].variableOption = res.data.data
            this.$forceUpdate()
          }
        })
    },
    powerCurveVariableChange(index, e) {
      // return
      let obj = {}
      obj = this.powerCurveForm.datas.data[index].variableOption.find(
        (item) => {
          return item.code === e //筛选出匹配数据
        }
      )
