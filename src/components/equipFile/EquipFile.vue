<template>
  <div class="equip-file">
    <MyBreadcrumb level1="产品管理" level2="设备档案" />
    <div class="content">
      <div class="c-left whiteBox">
        <div class="aside">
          <el-tree
            :data="tree"
            :props="defaultProps"
      ...
      <div class="c-right whiteBox">
        <!-- 当前设备不存则不显示操作 -->
        <div class="header" v-if="tree.length">
          <h4>{{ifMeterShow ? '设备信息' : ifEquipShow ? '类型信息' : ''}}</h4>
        </div>
        <div class="inner whiteBox" v-show="ifEquipShow || ifMeterShow">
          <!-- 设备 -->
                ...
                <div class="single">
                  ...
                  <div class="block-right">
                    <div class="sin-right">
                      ...
                      <el-input disabled v-model.trim="editEquipInfoForm.model"></el-input>
                    </div>
                    <div class="sin-right">
                    ...
                    <div class="sin-right">
                      ...
                      <el-select
                        ...
                        disabled
                        v-model.trim="editEquipInfoForm.productType"
                      >
                        <el-option
                    ...
                    <div class="sin-right">
                      ...
                      <el-select
                        ...
                        default-first-option
                        disabled
                        v-model.trim="editEquipInfoForm.providerName"
                        placeholder
                        @change="setInfo"
                      >
                        <el-option
                    ...
                    <div class="sin-right">
                      ...
                      <el-input disabled v-model.trim="editEquipInfoForm.factoryName"></el-input>
                    </div>
                    <div class="sin-right">
                      <div class="attr">厂家联系电话</div>
                      <el-input disabled v-model.trim="editEquipInfoForm.factoryPhone"></el-input>
                    </div>
                  </div>
                </div>
              </el-form>
          ...
          <div class="meter" v-show="ifMeterShow">
            <div class="edit">
              <el-form class="form" ref="editMeterInfoRef" :model="editMeterInfoForm">
                <div class="single">
                  ...
                  <div class="block-right">
                    ...
                    <div class="sin-right">
                      <div class="attr">备注名称</div>
                      <el-input v-model.trim="editMeterInfoForm.nickName"></el-input>
                    </div>
                    <div class="sin-right">
              ...
              <!-- 备件 -->
              <div class="component">
                <el-table :data="comDataArr" border stripe>
                  <el-table-column type="expand">
                    <template slot-scope="props">
                      <el-table :data="props.row.sparePartsList" border stripe size="mini">
                        ...
                        <el-table-column prop="operationTime" label="投运日期"></el-table-column>                                               
...
export default {
  ...
  methods: {
    ...
    getAllGroup(currentId) {
      ...
      this.$http
        .get("equipment/product/getTreeList", {
          params: {
    ...
    getequipDetailInfo() {
      ...
      this.$http
        .get("equipment/productFile/detail", {
          params: {
        ...
        .then((res) => {
          if (res.data.code === 0) {
            ...
            // 备件表格赋值
            if (
              this.editEquipInfoForm.sparePartsList &&
              this.editEquipInfoForm.sparePartsList.length > 0
            ) {
              for (
                var i = 0;
    ...
    editEquipInfoSubmit() {
      ...
      if (this.equipFile) {
        ...
        for (var key in this.editEquipInfoForm) {
          formdata.append(key, this.editEquipInfoForm[key]);
        }
      } else {
        formdata = this.editEquipInfoForm;
      }
      this.$http
          ...
          if (res.data.code === 0) {
            ...
            if (this.editMeterInfoForm.sparePartsList.length > 0) {
              for (
                ...
                id.push(this.editMeterInfoForm.sparePartsList[i].partsModel);
                id.push(this.editMeterInfoForm.sparePartsList[i].id.toString());
                // 拷贝二级菜单
                let sparePartsList = this.editMeterInfoForm.sparePartsList[i].sparePartsList.map(item => ({
                  operationTime: item.operationTime,
                  partsFactory: item.partsFactory,
                  partsName: item.partsName,
                  phone: "18812341234",
                  partsModel: item.partsModel,
                  partsId: item.id
                }))
                ...
                this.$set(this.comDataArr, i, {
                  id: id,
                  partsId: this.editMeterInfoForm.sparePartsList[i].id,                 
                  ...
                  phone: "18812341234",
                  partsModel: this.editMeterInfoForm.sparePartsList[i].partsModel,
                  sparePartsList
                })
              }
    ...
    replaceTime(row) {
      console.log(row);
      this.$http
        .post("equipment/equipConfig/replace", {
          // partsId: row.id[3],
          partsId: row.partsId,
        ...
        .then((res) => {
          if (res.data.code == 0) {
            this.comDataArr.forEach((item) => {
              if (item.partsId === res.data.data.partsId) {
                item.operationTime = res.data.data.operationTime;
                return;
              }
            });
            this.$notify({
    ...
    editMeterInfoSubmit() {
      ...
      //   }
      // }
      delete this.editMeterInfoForm['sparePartsList']
      if (this.meterFile) {
        //带图片文件
        ...
        formdata.append("nickName", this.editMeterInfoForm.nickName);
