  ...
  <div class="login">
    ...
    >
      ...
      <el-form-item class="user col" label prop="code">
        <el-input
          ...
          @keyup.enter.native="submitForm"
        >
          <div slot="suffix" class="font" style="right:5px">
    ...
    <div class="copy">
      <div class="container text-xs-center">
        <div>版权所有 © 智工运维（深圳）科技有限公司 <a href="https://beian.miit.gov.cn" target="_blank">粤ICP备2020098416号</a></div>
        <div>地址：深圳市宝安区宝石路29号蓝坤集团大厦B栋206    邮编：518000</div>
        <div>电话：0755-23289262</div>
      </div>
    </div>
  </div>
</template>
