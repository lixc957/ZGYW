<template>
  <div class="monitor">
    ...
    <div id="section">
      <!-- 左边栏 -->
      <div class="aside scroll whiteBox">
        <el-tree
          :data="tree"
          :props="defaultProps"
      ...
      <!-- 右边内容 -->
      <div class="main scroll whiteBox">
        <el-tabs
          class="hasBack-tab"
          type="border-card"
          @tab-click="tabChange"
        ...
        >
                  ...
                  <el-table :data="simulate_arr" border style="width: 100%">
                    ...
                    <el-table-column prop="value" label="实时值">
                      <template slot-scope="scope">{{
                        scope.row.value >= 0 ? scope.row.value : null
                      }}</template>
                    </el-table-column>
                ...
                <div class="simulate">
                  <el-table :data="simulate_arr" border style="width: 100%">
                    ...
                    <el-table-column prop="value" label="值">
                      <template slot-scope="scope">{{
                        scope.row.value ? scope.row.value : null
                      }}</template>
                    </el-table-column>
                    <el-table-column prop="unit" label="单位"></el-table-column>
                    <!-- <el-table-column label="操作">
          ...
          <el-tab-pane name="trend">
            ...
            <div class="data hasBacBox">
              <div class="time">
                ...
                <!-- <el-radio-group v-model="itemSelect" size="mini" style="float:right;">
              ...
              <div class="tab-his">
                <el-tabs
                  class="noBack-tab noMargin"
                  v-model="activeLine"
                  @tab-click="lineChange"
                  style="display: block"
                >
                  <el-tab-pane
          ...
          <el-tab-pane>
            ...
            <div class="data-table hasBacBox">
              <!-- 时间选项 -->
              <div class="time">
                <!-- 单选框 -->
                <el-radio-group
              ...
              <div class="table-area">
                ...
                >
                  <tr>
                    ...
                    <th v-for="item in filt_data" :key="item.id">
                      {{ item.name }}
                      <span v-if="unit != null && unit != ''"
                        >({{ unit }})</span
                      >
                    </th>
                  </tr>
    ...
    >
      ...
      <span slot="footer" class="dialog-footer">
        <el-button class="cancel" @click="editValueVisible = false"
          >取 消</el-button
        >
...
export default {
  ...
  methods: {
    ...
    lineChange() {
      this.line_total = {};
      this.getLine();
      this.lineUnit = this.getUnit(this.activeLine);
      console.log(this.lineUnit);
    },
    // 表格对齐方法
        ...
        .then((res) => {
          if (res.data.code === 0) {
            ...
            for (let i = 0; i < this.propertyOptions.length; i++) {
              if (this.propertyOptions[i].properties === "谐波") {
                this.propertyOptions.splice(i, 1);
                break;
              }
            }
            this.propertySelect = this.propertyOptions[0].id;
            this.unit = this.propertyOptions[0].unit;
            this.lineUnit = this.propertyOptions[0].unit;
          }
        });
    },
    // 获取曲线
    ...
    getPropertyChange() {
      this.getReport();
      this.unit = this.getUnit(this.propertySelect);
    },
    // 导出报表
    exportReport() {
    ...
    getUnit(valueSelect) {
      for (let i = 0; i < this.propertyOptions.length; i++) {
        if (parseInt(valueSelect) == this.propertyOptions[i].id) {
          return this.propertyOptions[i].unit;
        }
      }
    },
