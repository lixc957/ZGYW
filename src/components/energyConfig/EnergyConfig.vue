    ...
    <div class="energy-all scroll">
      <div class="energy-content">
        ...
        <div class="list whiteBox">
          ...
          <div class="list-show" ref="conBox">
            <el-table :max-height="conHeight" :data="tableData" border style="width: 100%" :row-style="rowStyle" stripe size="mini">             
...
export default {
  ...
  mounted() {
    ...
    this.getEnergyOptions_inSite();
    this.$nextTick(() => {
      this.conHeight = this.$refs.conBox.offsetHeight;
    });
        ...
        .then(res => {
          if (res.data.code === 0) {
            ...
            if (this.editEnergyForm.id) {
              ...
              this.properties =this.variableOptions&& this.variableOptions[index].properties;
            }
          }
        });
    },
