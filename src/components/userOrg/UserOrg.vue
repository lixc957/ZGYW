  ...
  <div class="user">
      ...
      <div class="inner whiteBox">
        ...
        >
            ...
            >
              ...
              >
                ...
                <div style v-show="!imgSrc" class="logo">
                  <i
                    class="el-icon-plus"
                    style="heigth: 14px; display: block"
                  ></i>
                </div>
                <img
                  id="imgId"
              ...
              <div class="input-layout">
                ...
                >
                  <el-input
                    v-model.trim="companyForm.responsibleName"
                  ></el-input>
                </el-form-item>
                <el-form-item
                  label="负责人电话"
                ...
                >
                  <el-input
                    v-model.trim="companyForm.responsiblePhone"
                  ></el-input>
                </el-form-item>
              </div>
              <div class="input-layout">
          ...
          <el-tab-pane label="用户管理" name="second">
            <el-button class="confirm" size="mini" @click="addUser"
              >+ 新增用户</el-button
            >
              ...
              >
                ...
                <el-table-column prop="siteDTOS" label="拥有站点" width="250">
                  <template slot-scope="scope">
                    <div
                      class="tag-single"
                      v-for="item in scope.row.siteDTOS"
                      :key="item.id"
                    >
          ...
          <el-tab-pane label="站点管理" name="third">
            <el-button class="confirm" size="mini" @click="addSite"
              >+ 新增站点</el-button
            >
            <div class="inner-table">
              <el-table
    ...
    >
      ...
      <span slot="footer" class="dialog-footer">
        <el-button class="cancel" @click="editUserVisible = false"
          >取 消</el-button
        >
    ...
    >
      ...
      >
        ...
        <div style="display: flex; justify-content: space-between">
          <el-form-item label="经度" prop="longitude">
            <el-input
              v-model.trim="siteForm.longitude"
              style="width: 180px"
            ></el-input>
          </el-form-item>
          <el-form-item label="纬度" prop="latitude">
            <el-input
              v-model.trim="siteForm.latitude"
              style="width: 180px"
            ></el-input>
          </el-form-item>
        </div>
      ...
      <span slot="footer" class="dialog-footer">
        <el-button class="cancel" @click="editSiteVisible = false"
          >取 消</el-button
        >
    ...
    >
      ...
      <span>是否确认删除站点 <mark>{{ delName }}</mark> ?</span>
      <span slot="footer" class="dialog-footer">
        <el-button class="cancel" @click="delSiteVisible = false"
          >取 消</el-button
        >
...
import { checkPhone, checkEmail, findArrIndex } from "../../utils";
export default {
  inject: ["reload"], //注入依赖
  components: {
    MyBreadcrumb,
      ...
      this.$refs.siteRef.validate((valid) => {
        if (valid) {
          if (this.dialogTitle == "编辑站点") {
            this.$http
              .post("equipment/roomUpdate", this.siteForm)
              .then((res) => {
                if (res.data.code == 0) {
                  this.$notify({
                    title: "成功",
