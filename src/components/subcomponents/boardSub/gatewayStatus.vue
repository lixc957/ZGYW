<template>
<!-- 网关在线状态 -->
  <div class="gatewayStatus hasBacBox">
    <div class="header" style>
      <div style class="title titleBox">
    ...
    <el-table :data="item.datas.data" border :show-header="false" :row-style="inlineStyle" class="table">
      ...
      <el-table-column prop="param" width="120">
        <template slot-scope="scope">
          ...
          >
            <i class="icon iconfont icon-lixian" style="color: rgb(246, 54, 54)"></i>
          </div>
          <div
            v-else
            style="display: flex; justify-content: center; align-items: center; color: #fff!important"
          >
            <i class="icon iconfont icon-zaixian" style="color: rgba(74, 225, 91)"></i>
          </div>
        </template>
      </el-table-column>
    </el-table>
