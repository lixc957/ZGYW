<template>
  ...
  <div class="wrapper">
    ...
    <div class="chart whiteBox hasBacBox" ref="chart"></div>
  </div>
</template>
      ...
      chart.setOption({
        ...
        tooltip: {
          ...
          position: function (point, params, dom, rect, size) {
            let disX = (size.viewSize[0] - size.contentSize[0]) / 2;
            let disY = (size.viewSize[1] - size.contentSize[1]) / 2;
            //其中params为当前鼠标的位置
            return [
              point[0] > disX ? disX : point[0],
              point[1] > disY ? disY : point[1],
            ];
          },
        ...
        series: [
          {
            ...
            radius: "80%", // 饼图的半径 数组的第一项是内半径，第二项是外半径
            ...
            label: {
              // align: "center",
              // show: true, // 默认 false
              position: "cneter", // 标签的位置 'outside', 'inside', 'inner'同'inside', 'center'
              // color: "#fff", // 文字的颜色
              // alignTo: "edge",
              // padding: [0, -70],
              // fontSize: 12 / this.scale, // 文字的字体大小
