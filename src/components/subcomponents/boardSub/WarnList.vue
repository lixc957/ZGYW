<template>
  <!-- 告警列表 -->
  <div class="warnList hasBacBox" ref="conBox">
    <div
      style="
        width: 100%;
        position: fixed;
    ...
    <el-table
      ...
      border
      style="width: 100%; margin-top: 4px; margin-top: 30px"
      size="small"
    >
...
export default {
  ...
  mounted() {
    this.$nextTick(() => {
      this.conHeight = this.$refs.conBox.offsetHeight - 30;
    });
  },
};
</script>
...
/* 下边框 */
.warnList >>> .el-table td,
.el-table th.is-leaf {
  border-bottom: 1px solid #777777;
}
/* 表头背景色 */
.warnList >>> .el-table th,
.el-table tr {
  background-color: rgba(78, 101, 122);
}
</style>