<template>
  <div class="real-time">
    ...
    <div class="content">
      ...
      <div class="bottom">
        <div class="b-center whiteBox">
          <div class="title titleBox">频率</div>
          <div class="b-c-content">
            <div class="text">
              <div class="frequency">
                <div>当前频率</div>
                <div class="titleBox">{{frequencyObj.frequency}}Hz</div>
              </div>
              <div class="deviation">
                <div>频率偏差</div>
                <div class="titleBox">{{frequencyObj.deviation}}%</div>
              </div>
            </div>
            <div class="pic">
              <div class="base">
        ...
        <div class="b-left whiteBox">
          <div class="title titleBox">电压</div>
        ...
        <div class="b-right whiteBox">
          <div class="title titleBox">有功功率</div>
          <div class="all-voltage">
            <div class="sin-voltage">
        ...
        <div class="b-right-r whiteBox">
          <div class="title titleBox">无功功率</div>
          <div class="all-voltage">
            <div class="sin-voltage">
              <div class="attr">A</div>
              <div class="line">
