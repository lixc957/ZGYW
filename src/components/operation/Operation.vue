      ...
      <div class="table-Content">
        ...
        <section>
          <el-table
            ...
            style="width: 99%;margin-left: 8px;"
            v-loading="loading"
          >
                ...
                <template v-if="scope.row.status === '0'">
                  ...
                  >
                    <el-button size="mini" class="del" @click="forbiddenOperation(scope.row)">
                      <i class="icon iconfont icon-tabledisable mini"></i>
                    </el-button>
                  </el-tooltip>
                </template>
                <template v-else>
                  <el-tooltip class="item" effect="dark" content="已禁用" placement="top-start">
                    <el-button size="mini" type="info">
                      <i class="icon iconfont icon-yijinyong mini"></i>
                    </el-button>
                  </el-tooltip>
                </template>
              </template>
...
export default {
  ...
  mounted() {
    this.$nextTick(() => {
      this.conHeight = this.$refs.conBox.offsetHeight - 110;
    });
