...
import VariatePacket from '../components/variate/VariatePacket.vue'
import IntervalControl from '../components/switchControl/IntervalControl.vue'
import SubscribeControl from '../components/switchControl/SubscribeControl.vue'
import WorkHistory from '../components/switchControl/WorkHistory.vue'
// 创建路由对象
  ...
  routes: [{
    ...
    },
    {
      ...
      children: [
        {
          path: 'workRule',
          component: () => import('../components/workRule/WorkRule')
        },
        {
          path: 'order',
          component: () => import('../components/order/OrderOperation')
        },
        {
          path: 'orderPlatform',
          component: () => import('../components/orderPlatform/OrderPlatform')
        },
        {
          path: 'maintainContent',
          component: () => import('../components/maintainContent/MaintainContent')
        },
        {
          path: 'welcome',
          component: Welcome
        ...
        {
          path: 'variatePacket',
          component: VariatePacket,
        },
        {
          path: 'intervalControl',
          component: IntervalControl,
        },
        {
          path: 'subscribeControl',
          component: SubscribeControl,
        },
        {
          path: 'workHistory',
