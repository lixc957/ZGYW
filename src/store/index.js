  ...
  mutations: {
    ...
    site_change(state, param) {
      if (param.sites.length > 0) {
        ...
        state.site.siteScreenUrl = param.siteScreenUrl
      } else {
        state.site = {
          siteId: null,
    ...
    siteChange(state, siteObj) {
      ...
      state.site.siteScreenUrl = siteObj.siteScreenUrl
    },
    // 下拉刷新当前站点
      ...
      if (param.sites.length > 0) {
        ...
        if (index < 0) {
          ...
          if (state.site.siteList.length > 0) {
            ...
            state.site.siteScreenUrl = state.site.siteList[0].siteScreenUrl
          ...
          state.site.siteScreenUrl = state.site.siteList[index].siteScreenUrl
        }
